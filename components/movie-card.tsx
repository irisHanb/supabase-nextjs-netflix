...
export default function MovieCard() {
  return (
    <div className="col-span-1 relative">
      ...
      {/* dim */}
      <Link href={`/movies/1`}>
        <div className="flex items-center justify-center absolute top-0 bottom-0 left-0 right-0 z-10 bg-black opacity-0 hover:opacity-80 transition-opacity duration-300 cursor-pointer">
